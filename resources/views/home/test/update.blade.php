    ...
    <div class="box-header">
        <el-header  id="content-header">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item><a href="{{ route('home.test.index') }}">活动</a></el-breadcrumb-item>
                ...
                onSubmit(form) {
                    this.$refs[form].validate((valid) => {
                        if (valid) {
                            ...
                            this.doPost('{{ route('home.test.update') }}',this.form).then(res=>{
                                this.submitLoading=false;
                                if(res.errcode==0){
                                    this.$message.success('操作成功!');
                                    window.location.href='{{ route('home.test.index') }}';
                                }else{
