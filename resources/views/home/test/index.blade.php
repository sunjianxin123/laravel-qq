                ...
                <el-col :span="6">
                     ...
                     <el-col :span="4">
                        <el-form-item label="模板名称">
                            <el-input v-model="form.name" @keyup.enter.native="getData()"></el-input>
                        </el-form-item>
                    </el-col>
                     <el-col :span="4">
                     ...
                     <el-col :span="4">
                        <el-form-item label="是否显示">
                            <el-select v-model="form.referer">
                                <el-option label="全部" value="0"></el-option>
                                <el-option label="PC" value="1"></el-option>
                                <el-option label="无线端" value="2"></el-option>
                            </el-select>
                        </el-form-item>
                     </el-col>
                <el-col :span="4">
                    <el-form-item>
                        ...
                        <a href="{{ route('home.test.update') }}" target="_blank"><el-button type="danger">添加</el-button></a>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <a :href="'{{ route('home.test.update') }}?id='+scope.row.id" target="_blank">
           ...
           var vm = new Vue({
             ...
             methods: {
                 ...
                 getData(page=1){
                     ...
                     this.doGet('{{ route('home.test.index') }}',this.form).then(res => {
                         if(res.errcode==0){
                 ...
                 handelDelete(id){
                     this.$confirm('确认删除吗？', '提示', {
                         ...
                         this.doPost('{{ route('home.test.delete') }}',{id:id}).then(res => {
                             if(res.errcode==0){
                                 this.getData();
                             }else{
