                ...
                <el-col :span="7">
                 ...
                 <el-col :span="4">
                    <el-form-item label="属性名">
                        <el-input v-model="form.attr_name" @keyup.enter.native="getData()"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="4">
                    <el-form-item>
                        <el-button type="primary" @click="getData()">查询</el-button>
                        <a href="{{ route('home.attribute.update') }}" target="_blank"><el-button type="danger">添加</el-button></a>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <a :href="'{{ route('home.attribute.update') }}?id='+scope.row.id" target="_blank">
           ...
           var vm = new Vue({
             ...
             methods: {
                 ...
                 getData(page=1){
                     ...
                     this.doGet('{{ route('home.attribute.index') }}',this.form).then(res => {
                         if(res.errcode==0){
                 ...
                 handelDelete(id){
                     this.$confirm('确认删除吗？', '提示', {
                         ...
                         this.doPost('{{ route('home.attribute.delete') }}',{id:id}).then(res => {
                             if(res.errcode==0){
                                 this.getData();
                             }else{
