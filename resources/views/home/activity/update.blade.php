    ...
    <div class="box-header">
        <el-header  id="content-header">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item><a href="{{ route('home.activity.index') }}">活动</a></el-breadcrumb-item>
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                    ...
                    <el-form-item label="活动标题" prop="title">
                        ...
                        <el-form-item label="APP活动">
                            <el-switch v-model="form.in_app"></el-switch>
                        </el-form-item>
                ...
                onSubmit(form) {
                    this.$refs[form].validate((valid) => {
                        if (valid) {
                            ...
                            this.doPost('{{ route('home.activity.update') }}',this.form).then(res=>{
                                this.submitLoading=false;
                                if(res.errcode==0){
                                    this.$message.success('操作成功!');
                                    window.location.href='{{ route('home.activity.index') }}';
                                }else{
