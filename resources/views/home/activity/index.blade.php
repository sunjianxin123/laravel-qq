            ...
            <el-row>
                ...
                <el-col :span="4">
                    <el-form-item>
                        ...
                        <a href="{{ route('home.activity.update') }}" target="_blank"><el-button type="danger">添加</el-button></a>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <a :href="'{{ route('home.activity.update') }}?id='+scope.row.id" target="_blank">
           ...
           var vm = new Vue({
             ...
             methods: {
                 ...
                 getData(page=1){
                     ...
                     this.doGet('{{ route('home.activity.index') }}',this.form).then(res => {
                         if(res.errcode==0){
                 ...
                 handelDelete(id){
                     this.$confirm('确认删除吗？', '提示', {
                         ...
                         this.doPost('{{ route('home.activity.delete') }}',{id:id}).then(res => {
                             if(res.errcode==0){
                                 this.getData();
                             }else{
